...
This project is part of the Digital Literacy (CSE0001) course at VIT Bhopal University.
As a Student Digital Ambassador, the objective of this project is to build a Digital Literacy Portfolio that demonstrates essential skills required to navigate the digital world effectively.
...
Explored coding platforms and completed beginner-level challenges to build problem-solving skills.
Also created a Digital Literacy Awareness Quiz using Google Forms.
...
2.Navigate through each task folder

3.View screenshots, documents, and files

4.Access the Google Form using the provided link

5.Open the report file for detailed explanations
